                    ...
                    <div class="header-top-navigation">
                        <nav>
                            <ul>
                                ...
                                <li class="notification-trigger"><a class="msg-trigger-btn" href="#b"><i class="fa-solid fa-bell"></i></a>
                        ...
                        <div class="profile-setting-box">
                            <div class="profile-thumb-small">
                                <a href="javascript:void(0)" class="profile-triger">
                                    <figure>
                                        <img src="../../assets/img/profile5.jpg" alt="profile picture">
                                    </figure>
                                </a>
                        ...
                        <div class="card card-profile widget-item p-0 rounded-2">
                            <div class="profile-banner">
                                <figure class="profile-banner-small">
                                    <a href="profile.html">
                                        <img src="../../assets/img/post3.png" class="rounded-2" alt="">
                                    </a>
                                ...
                                <div class="profile-desc text-center">
                                    <h5 class="mb-0"> <a href="#!">Prince Rajpoot</a> </h5>
